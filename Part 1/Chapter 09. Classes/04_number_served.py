...
a = Restaurant('YourFood', 'whatever')

print(f'The initial number of customers: {a.num_served}.')
a.num_served = 2
print(f'The new number of customers: {a.num_served}.')

a.set_number_served(23)
print(f'The updated number of customer with the method is: {a.num_served}.')

a.increment_num_served(5)
print(f'Incrementing, the number of customers is: {a.num_served}.')
