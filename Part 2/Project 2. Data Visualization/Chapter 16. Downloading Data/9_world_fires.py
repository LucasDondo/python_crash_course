...
fig = px.scatter_geo(
    ...
    hover_name=top_hover_txts,
    size=top_brightnesses,
...
fig = px.line(
    title="🔥 Daily Fire Brightness in Argentina, 2022 👨🏼‍🚒",
    x=unique_dates,
    y=brightnesses_per_days,
...
fig = px.pie(
    title="🔥 Day/Night Fires in Argentina, 2022 👨🏼‍🚒",
    values=[q_days, q_nights],
    names=["Day", "Night"],
