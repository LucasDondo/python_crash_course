...
#                      color=top_brightnesses, color_continuous_scale='YlOrRd',
...
# fig = px.line(title='🔥 Daily Fire Brightness in Argentina, 2022 👨🏼‍🚒', x=unique_dates,
#               y=brightnesses_per_days, labels={'x': 'Date', 'y': 'Brightness'})
...
fig = px.pie(title='🔥 Day/Night Fires in Argentina, 2022 👨🏼‍🚒',
             ...
             color_discrete_sequence=[px.colors.qualitative.Safe[0], px.colors.qualitative.Safe[4]])
